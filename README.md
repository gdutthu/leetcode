...
|      题目分类      |                           题目编号                           |
| :----------------: | :----------------------------------------------------------: |
| 二分查找应用(简单) | [374](https://leetcode-cn.com/problems/guess-number-higher-or-lower/)、[35](https://leetcode-cn.com/problems/search-insert-position/)、[278](https://leetcode-cn.com/problems/first-bad-version/)、[367](https://leetcode-cn.com/problems/valid-perfect-square/)、69、441 |
